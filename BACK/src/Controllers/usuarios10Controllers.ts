import * as usuarios10Repositories from "../Repositories/usuarios10Repositories.js"
...
export const gettingOne10Usuario = async (req: Request, res: Response) => {
    const Id_Usuario = Number(req.params.Id_Usuario)
    try {
        const usuario = await usuarios10Repositories.gettingOne10Usuario(Id_Usuario)
...
export const gettingAll10Usuarios = async (req: Request, res: Response) => {
    try {
        const usuarios = await usuarios10Repositories.gettingAll10Usuarios()
...
export const login = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const checkUsuario = await usuarios10Repositories.checkingOne10Usuario(Usuario)
