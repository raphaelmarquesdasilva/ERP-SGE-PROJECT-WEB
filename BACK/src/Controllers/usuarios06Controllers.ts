import * as usuarios06Repositories from "../Repositories/usuarios06Repositories.js"
...
export const gettingOne06Usuario = async (req: Request, res: Response) => {
    const Id_Usuario = Number(req.params.Id_Usuario)
    try {
        const usuario = await usuarios06Repositories.gettingOne06Usuario(Id_Usuario)
...
export const gettingAll06Usuarios = async (req: Request, res: Response) => {
    try {
        const usuarios = await usuarios06Repositories.gettingAll06Usuarios()
...
export const login = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const checkUsuario = await usuarios06Repositories.checkingOne06Usuario(Usuario)
