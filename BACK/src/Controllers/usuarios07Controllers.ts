import * as usuarios07Repositories from "../Repositories/usuarios07Repositories.js"
...
export const gettingOne07Usuario = async (req: Request, res: Response) => {
    const Id_Usuario = Number(req.params.Id_Usuario)
    try {
        const usuario = await usuarios07Repositories.gettingOne07Usuario(Id_Usuario)
...
export const gettingAll07Usuarios = async (req: Request, res: Response) => {
    try {
        const usuarios = await usuarios07Repositories.gettingAll07Usuarios()
...
export const login = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const checkUsuario = await usuarios07Repositories.checkingOne07Usuario(Usuario)
