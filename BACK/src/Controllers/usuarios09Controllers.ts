import * as usuarios09Repositories from "../Repositories/usuarios09Repositories.js"
...
export const gettingOne09Usuario = async (req: Request, res: Response) => {
    const Id_Usuario = Number(req.params.Id_Usuario)
    try {
        const usuario = await usuarios09Repositories.gettingOne09Usuario(Id_Usuario)
...
export const gettingAll09Usuarios = async (req: Request, res: Response) => {
    try {
        const usuarios = await usuarios09Repositories.gettingAll09Usuarios()
...
export const login = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const checkUsuario = await usuarios09Repositories.checkingOne09Usuario(Usuario)
